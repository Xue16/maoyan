  ...
  <section id="city-list" class="city-list-container">
    <van-index-bar :sticky="false" :index-list="indexList">
      ...
      <section>
        ...
        <div class="city-list city-list-inline clearfix">
          <div class="city-item" v-for="(hot, index) in cityData.hotCities" :key="index"
          @click="pickCity(hot)" >{{hot.name}}</div>
        </div>
      </section>
      <section>
        ...
        <div class="city-list city-list-block clearfix">
          <div class="city-item"  v-for="(ci, index) in cities" :key="index" @click="pickCity(ci)">{{ci.name}}</div>
        </div>
    </template>
      </section>
    </van-index-bar>
